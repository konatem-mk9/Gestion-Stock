...
class CategoryController extends VoyagerBaseController
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        $parents = Category::with('subcategory')->whereNull('parent_id')->get();

        $cat = Category::find($id);
        $categoriesForParent = $cat->subcategory()->get();

        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'parents','categoriesForProduct'));
    }
    ...
    { 
        ...
        $this->updateSubCategories($request, $data->id);
    ...
    public function create(Request $request)
    {
        ...
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'parents'));
    }
    ...
    protected function updateSubCategories(Request $request, $id)
    {
        ...
        if ($request->category) {
            ...
            $cat->categorie_parent = $parent->nom;
