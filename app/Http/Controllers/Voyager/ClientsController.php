...
class ClientsController extends VoyagerBaseController
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        $typeForFornissuer = $client->type()->get();

        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'types','typeForFornissuer'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $this->updateType($request, $data->id);
    ...
    {
        if ($request->type) {
            $fournisseur = Client::find($id);
            $type= Type::find($request->type);
            $fournisseur->type_id =$request->type;
            $fournisseur->type=$type->dénomination;
