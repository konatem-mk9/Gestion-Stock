...
class VentesController extends VoyagerBaseController
{
    ...
    public function update(Request $request, $id)
    {
        ...
        // $this->updateStockonPaid($data);  
        $this->updateStockonPaid($request->payé, $oldPaidValue, $id);
    ...
    protected function updateStockonPaid($newPaid,$oldPaid,$id){
        $vente = Vente::find($id);

        $vente->payé = $newPaid + $oldPaid;

        $vente->restant = $vente->total - $vente->payé;
        $vente->save();
    }
    //***************************************
    //
