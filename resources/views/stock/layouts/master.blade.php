...
<head>
  ...
  <script src="{{url('public/js/quagga.js')}}"></script>
  <link rel="stylesheet" href="{{url('public/css/quagga.css')}}">
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <!-- <img src="{{url('public/adminlte')}}/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8"> -->
      <span class="brand-text font-weight-light">Visualisation</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Bienvenu(e)  </a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{route('goAdmin')}}" class="nav-link">
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong> Visualisation  & commandes .</strong>
  </footer>
</div>
<!-- ./wrapper -->
