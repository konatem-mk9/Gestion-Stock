                    ...
                    <form role="form"
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group" style="width:98%; margin: 0 auto">
                                <label>Type de Fournisseur</label>
                                <select class="form-control custom-select" name="type">
                                            <option value="" selected disabled hidden>-- Choisir type de fournisseur --</option>

                                            @foreach ($types as $type)
                                            <option style="margin-bottom:5px " value="{{ $type->id }}" {{ $typeForFornissuer->contains($type) ? 'selected' : '' }}>{{ $type->dénomination }}</option>
                                            @endforeach
                                        </select>
