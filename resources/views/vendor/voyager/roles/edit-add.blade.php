                                     ...
                                     @if(!($table=='menus' || $table=='settings'))
                                        ...
                                        <ul>
                                            @foreach($permission as $perm)
                                                @if( !(
                                                      $perm->key=="browse_bread" ||
                                                      $perm->key=="browse_database" ||
                                                      $perm->key=="browse_media" ||
                                                      $perm->key=="browse_compass" 
                                                        ...
                                                        <li>
                                                            ...
                                                            <label for="permission-{{$perm->id}}"> {{rolesNames(\Illuminate\Support\Str::title(str_replace('_', ' ', $perm->key))) }}</label>
                                                        </li>
